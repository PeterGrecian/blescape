...
do audio syntheses based on the sources.  Give them static random directions for now and do simple stereo based on head rotation.Im not getting dynamic panning. The sources do not rotate as I rotate the phone.
